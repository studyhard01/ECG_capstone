...
__all__ = ['ST_MEM_ViT_LEAD', 'st_mem_vit_lead_small', 'st_mem_vit_lead_base']


class ST_MEM_ViT_LEAD(nn.Module):
    def __init__(self,
                 seq_len: int,
                 patch_size: int,
                 num_leads: int,
...
def st_mem_vit_lead_small(num_leads, num_classes=None, seq_len=2250, patch_size=75, **kwargs):
    model_args = dict(seq_len=seq_len,
                      ...
                      mlp_dim=1536,
                      **kwargs)
    return ST_MEM_ViT_LEAD(**model_args)


def st_mem_vit_lead_base(num_leads, num_classes=None, seq_len=2250, patch_size=75, **kwargs):
    model_args = dict(seq_len=seq_len,
                      patch_size=patch_size,
                      num_leads=num_leads,
                      num_classes=num_classes,
...
'''
class ST_MEM_ViT_LEAD_shffle(nn.Module):
    def __init__(self,
                 seq_len: int,
                 patch_size: int,
                 num_leads: int,
...
'''
class ST_MEM_ViT_LEAD_random(nn.Module):
    def __init__(self,
                 seq_len: int,
                 patch_size: int,
                 num_leads: int,
